# Generated by Django 2.0.4 on 2018-05-13 06:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_event', models.ManyToManyField(blank=True, related_name='assigned', to='website.Event')),
                ('availability', models.ManyToManyField(blank=True, related_name='availability', to='website.Event')),
